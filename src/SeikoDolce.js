  ...
  return (
    <article className='py-8 px-4 lg:px-32 gap-4 flex flex-col lg:flex-row min-h-screen pt-20'>
      ...
      <div className='flex-1 m-4 p-4 lg:pb-96 font-libre text-indigo-600 w-full'>
        ...
        <button
          className={`bg-indigo-600 hover:bg-slate-500 text-slate-300 hover:text-indigo-600 w-80 h-10 mb-4 ${
        ...
        <br />
        <button className='bg-indigo-600 text-slate-300 w-80 h-10 mb-4 hover:bg-slate-500 hover:text-indigo-600'>
          BUY NOW
        </button>
