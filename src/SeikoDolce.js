...
const SeikoDolce = () => {
  ...
  const [mainImage, setMainImage] = useState(
    `${process.env.PUBLIC_URL}/img/Seiko-Dolce.jpeg`
  );
  const additionalImages = [
    `${process.env.PUBLIC_URL}/img/Seiko-Dolce.jpeg`,
    `${process.env.PUBLIC_URL}/img/Seiko-Dolce2.jpeg`,
    `${process.env.PUBLIC_URL}/img/Seiko-Dolce3.jpeg`,
    `${process.env.PUBLIC_URL}/img/Seiko-Dolce4.jpeg`,
  ];

  const handleAddToCart = () => {
    const product = {
      id: 1,
      name: 'Seiko Dolce 9531-5040',
      price: 1500000,
      image: mainImage,
      quantity,
    };
  ...
  return (
    <article className='py-8 px-4 lg:px-32 gap-4 flex flex-col lg:flex-row min-h-screen pt-20'>
      ...
      <div className='flex-1 m-4 p-4 lg:pb-96 font-libre text-emerald-900 w-full'>
        <h1 className='text-2xl pb-4 lg:text-3xl'>₦1,500,000.00</h1>
        <h1 className='text-2xl pb-4 lg:text-4xl'>Seiko Dolce 9531-5040</h1>
        ...
        <button
          className={`bg-emerald-900 hover:bg-slate-500 text-slate-300 hover:text-emerald-900 w-80 h-10 mb-4 ${
        ...
        <br />
        <button className='bg-emerald-900 text-slate-300 w-80 h-10 mb-4 hover:bg-slate-500 hover:text-emerald-900'>
          BUY NOW
        </button>
