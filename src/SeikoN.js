...
const SeikoN = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      price: 1050000,
      image: `${process.env.PUBLIC_URL}/img/SeikoN.jpeg`,
      quantity,
    };
  ...
  return (
    <article className='py-8 px-4 lg:px-32 gap-4 flex flex-col lg:flex-row min-h-screen pt-20'>
      <div className='lg:flex-1 w-full'>
        <img
          src={`${process.env.PUBLIC_URL}/img/SeikoN.jpeg`}
          alt='Seiko Nautilus'
          className='w-full md:max-w-2xl md:mx-auto'
        />
      </div>
      <div className='flex-1 m-4 p-4 lg:pb-96 font-libre text-emerald-900 w-full'>
        <h1 className='text-2xl pb-2 lg:text-3xl'>₦1,050,000.00</h1>
        <h1 className='text-2xl pb-2 lg:text-4xl'>Seiko Nautilus SNKK52</h1>
