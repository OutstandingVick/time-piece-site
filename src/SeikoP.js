...
const SeikoP = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      price: 963200,
      image: `${process.env.PUBLIC_URL}/img/SeikoP.jpeg`,
      quantity,
    };
  ...
  return (
    <article className='py-8 px-4 lg:px-32 gap-4 flex flex-col lg:flex-row min-h-screen pt-20'>
      <div className='lg:flex-1 w-full'>
        <img
          src={`${process.env.PUBLIC_URL}/img/SeikoP.jpeg`}
          alt='Seiko Nautilus'
          className='w-full md:max-w-2xl md:mx-auto'
        />
      </div>
      <div className='flex-1 m-4 p-4 lg:pb-96 font-libre text-emerald-900 w-full'>
        <h1 className='text-2xl pb-2 lg:text-3xl'>₦963,200.00</h1>
        <h1 className='text-2xl pb-2 lg:text-4xl'>Seiko Presage Cocktail</h1>
        ...
        <br />
        <button className='bbg-emerald-900 text-slate-300 w-96 h-10 mb-4 hover:bg-slate-500 hover:text-emerald-900'>
          BUY NOW
        </button>
