...
const Hamilton = () => {
  ...
  const [mainImage, setMainImage] = useState(
    `${process.env.PUBLIC_URL}/img/Hamilton.jpeg`
  );
  const additionalImages = [
    `${process.env.PUBLIC_URL}/img/Hamilton.jpeg`,
    `${process.env.PUBLIC_URL}/img/Hamilton2.jpeg`,
    `${process.env.PUBLIC_URL}/img/Hamilton3.jpeg`,
    `${process.env.PUBLIC_URL}/img/Hamilton4.jpeg`,
  ];
