...
const Seiko7731 = () => {
  ...
  const [mainImage, setMainImage] = useState(
    `${process.env.PUBLIC_URL}/img/Seiko7731.jpeg`
  );
  const additionalImages = [
    `${process.env.PUBLIC_URL}/img/Seiko7731.jpeg`,
    `${process.env.PUBLIC_URL}/img/Seiko7731-2.jpeg`,
    `${process.env.PUBLIC_URL}/img/Seiko7731-3.jpeg`,
    `${process.env.PUBLIC_URL}/img/Seiko7731-4.jpeg`,
  ];
  ...
  return (
    <article className='py-8 px-4 lg:px-32 gap-4 flex flex-col lg:flex-row min-h-screen pt-20'>
      ...
      <div className='flex-1 m-4 p-4 lg:pb-96 font-libre text-emerald-900 w-full'>
        <h1 className='text-xl pb-4 lg:text-3xl'>₦800,000.00</h1>
        <h1 className='text-xl pb-4 lg:text-4xl'>Seiko Dolce 7731</h1>
