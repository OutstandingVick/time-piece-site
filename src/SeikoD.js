...
const SeikoD = () => {
  ...
  const [mainImage, setMainImage] = useState(
    `${process.env.PUBLIC_URL}/img/SeikoD.jpeg`
  );
  const additionalImages = [
    `${process.env.PUBLIC_URL}/img/SeikoD.jpeg`,
    `${process.env.PUBLIC_URL}/img/SeikoD2.jpeg`,
    `${process.env.PUBLIC_URL}/img/SeikoD3.jpeg`,
    `${process.env.PUBLIC_URL}/img/SeikoD4.jpeg`,
  ];
