...
const CasioED = () => {
  ...
  const [mainImage, setMainImage] = useState(
    `${process.env.PUBLIC_URL}/img/CasioED.jpeg`
  );
  const additionalImages = [
    `${process.env.PUBLIC_URL}/img/CasioED.jpeg`,
    `${process.env.PUBLIC_URL}/img/CasioED2.jpeg`,
    `${process.env.PUBLIC_URL}/img/CasioED3.jpeg`,
    `${process.env.PUBLIC_URL}/img/CasioED4.jpeg`,
  ];
