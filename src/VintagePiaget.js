...
const VintagePiaget = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: 1,
      name: 'Piaget Lapis Lazuli',
      price: 90000000,
      image: `${process.env.PUBLIC_URL}/img/Vintage-Piaget.jpeg`,
      quantity,
    };
  ...
  return (
    <article className='py-8 px-4 lg:px-32 gap-4 flex flex-col lg:flex-row min-h-screen pt-20'>
      ...
      <div className='flex-1 m-4 p-4 lg:pb-96 font-libre text-indigo-600 w-full'>
        <h1 className='text-2xl pb-2 lg:text-3xl'>₦90,000,000.00</h1>
        <h1 className='text-2xl pb-2 lg:text-4xl'>
          Piaget Lapis Lazuli (Eye of the Tiger)
        </h1>
