...
const Rolex2 = () => {
  ...
  return (
    <article className='py-8 pt-20 px-4 lg:px-32 gap-4 flex flex-col lg:flex-row min-h-screen'>
      <div className='lg:flex-1 w-full'>
        <br />
        <img
          src={`${process.env.PUBLIC_URL}/img/Rolex2.jpeg`}
          alt='Casio LTP VTO'
          className='w-full md:max-w-2xl md:mx-auto'
        />
      </div>
      <div className='flex-1 m-4 p-4 lg:pb-96 font-libre text-indigo-600 w-full'>
        <h1 className='text-2xl pb-2 lg:text-3xl'>₦547,743,900.00</h1>
        <h1 className='text-2xl pb-2 lg:text-4xl'>
          Rolex Daytona Baguette cut Sapphires set in rainbow
        </h1>
