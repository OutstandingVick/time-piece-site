...
const TimexST = () => {
  ...
  const [mainImage, setMainImage] = useState(
    `${process.env.PUBLIC_URL}/img/TimexST.jpeg`
  );
  const additionalImages = [
    `${process.env.PUBLIC_URL}/img/TimexST.jpeg`,
    `${process.env.PUBLIC_URL}/img/TimexST2.jpeg`,
    `${process.env.PUBLIC_URL}/img/TimexST3.jpeg`,
  ];
