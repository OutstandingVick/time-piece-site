...
const PatekG = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      price: 1050000000,
      image: `${process.env.PUBLIC_URL}/img/PatekG.jpeg`,
      quantity,
    };
