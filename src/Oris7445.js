...
const Oris7445 = () => {
  ...
  const [mainImage, setMainImage] = useState(
    `${process.env.PUBLIC_URL}/img/Oris-7445.jpeg`
  );
  const additionalImages = [
    `${process.env.PUBLIC_URL}/img/Oris-7445.jpeg`,
    `${process.env.PUBLIC_URL}/img/Oris2.jpeg`,
    `${process.env.PUBLIC_URL}/img/Oris3.jpeg`,
    `${process.env.PUBLIC_URL}/img/Oris4.jpeg`,
  ];
    ...
    <article className='py-8 px-4 lg:px-32 gap-4 flex flex-col lg:flex-row min-h-screen pt-20 overflow-hidden'>
      <div className='lg:flex-1 w-full'>
        <img
          src={mainImage}
          alt='Oris 7445'
          className='w-full md:max-w-2xl md:mx-autoll max-w-2xl'
        />
      ...
      <div className='flex-1 m-4 p-4 lg:pb-96 font-libre text-indigo-600 w-full'>
        <h1 className='text-2xl pb-4 lg:text-3xl'>₦900,000.00</h1>
        <h1 className='text-2xl pb-4 lg:text-4xl'>Oris SA-7445</h1>
