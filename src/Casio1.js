...
const Casio1 = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      price: 160000,
      image: `${process.env.PUBLIC_URL}/img/Casio1.jpeg`,
      quantity,
    };
  ...
  return (
    <article className='py-8 px-4 lg:px-32 gap-4 flex flex-col lg:flex-row min-h-screen pt-20'>
      ...
      <div className='flex-1 m-4 p-4 lg:pb-96 font-libre text-emerald-900 w-full'>
        <h1 className='text-2xl pb-2 lg:text-3xl'>₦160,000.00</h1>
        <h1 className='text-2xl pb-2 lg:text-4xl'>Casio LTP-VT02BL-3A</h1>
