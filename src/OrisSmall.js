...
const OrisSmall = () => {
  ...
  const [mainImage, setMainImage] = useState(
    `${process.env.PUBLIC_URL}/img/Oris-Small.jpeg`
  );
  const additionalImages = [
    `${process.env.PUBLIC_URL}/img/Oris-Small.jpeg`,
    `${process.env.PUBLIC_URL}/img/Oris-Small2.jpeg`,
    `${process.env.PUBLIC_URL}/img/Oris-Small3.jpeg`,
    `${process.env.PUBLIC_URL}/img/Oris-Small4.jpeg`,
  ];
  ...
  return (
    <article className='py-8 px-4 lg:px-32 gap-4 flex flex-col lg:flex-row min-h-screen pt-20'>
      <div className='lg:flex-1 w-full'>
        <img
          src={mainImage}
          alt='Vintage Oris Small Seconds'
      ...
      <div className='flex-1 m-4 p-4 lg:pb-96 font-libre text-emerald-900 w-full'>
        <h1 className='text-xl pb-4 lg:text-3xl'>₦850,000.00</h1>
        <h1 className='text-xl pb-4 lg:text-4xl'>Vintage Oris Small Seconds</h1>
