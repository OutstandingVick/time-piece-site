...
const OrientL = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      price: 990000,
      image: `${process.env.PUBLIC_URL}/img/OrientL.jpeg`,
      quantity,
    };
