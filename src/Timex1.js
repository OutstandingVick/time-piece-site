...
const Timex1 = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      price: 130000,
      image: `${process.env.PUBLIC_URL}/img/Timex1.jpeg`,
      quantity,
    };
  ...
  return (
    <article className='py-8 px-4 lg:px-32 gap-4 flex flex-col lg:flex-row min-h-screen pt-20 overflow-hidden'>
      <div className='lg:flex-1 w-full'>
        <img
          src={`${process.env.PUBLIC_URL}/img/Timex1.jpeg`}
          alt='Timex'
          className='w-full max-w-2xl'
        />
      </div>
      <div className='flex-1 m-4 p-4 lg:pb-96 font-libre text-indigo-600 w-full'>
        <h1 className='text-2xl pb-2 lg:text-3xl'>₦130,000.00</h1>
        <h1 className='text-2xl pb-2 lg:text-4xl'>Timex Waterbury</h1>
