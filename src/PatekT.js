...
const PatekT = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      ...
      price: 2250000000,
      image: `${process.env.PUBLIC_URL}/img/PatekT.jpeg`,
      quantity,
    };
